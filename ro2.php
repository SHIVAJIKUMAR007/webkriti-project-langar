...
<body>
    <div style=" background-image:url('https://dailyhdwallpaper.com/wp-content/uploads/Pizza-Food-Delicious-Photo-Wallpaper-2048x1536.jpg'); background-repeat: no-repeat; 
...
<td style="font-weight:bold; font-size:25px; display:inline; margin-right:80px;"><a href="logout.php" style="text-decoration: none;margin-top:0px;display:inline; color: rgb(51, 202, 13);">LOGOUT</a> </td>
        ...
        <center><h2>your restaurant id = 2</h2></center>
        </div>
